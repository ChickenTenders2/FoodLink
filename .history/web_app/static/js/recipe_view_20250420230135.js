...
function add_ingredient_row(name = "", quantity = "", unit = "", recipe_id) {
    ...
    document.getElementById("hidden_recipe_id").value = recipe_id;

    document.getElementById('edit_ingredients_form').addEventListener('submit', function(event) {
        event.preventDefault();
        
        // Get recipe_id from hidden input
        const recipe_id = document.getElementById("hidden_recipe_id").value;
