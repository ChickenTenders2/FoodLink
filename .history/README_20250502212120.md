...
- Item management system utilising the camera sensor to add items ---> Aids in the management of food inventory using visual computing features such as YOLO object detection and barcode recognition and decoding.
